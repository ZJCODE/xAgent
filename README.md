...
- [✨ Key Features](#-key-features)
  - [🤖 Multi-Modal AI Chat](#-multi-modal-ai-chat)
...
- [🚀 Quick Start](#-quick-start)
  ...
  - [Running the Application](#running-the-application)
    ...
    - [⚙️ Manual Start (Individual Services)](#%EF%B8%8F-manual-start-individual-services)
...
- [⚡ Best Practices](#-best-practices)
  - [Always Use Async Context](#always-use-async-context)
  - [Smart Tool Selection](#smart-tool-selection)
