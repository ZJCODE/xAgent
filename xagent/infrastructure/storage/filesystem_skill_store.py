...
from ...domain.skills import SkillMetadata, SkillValidationIssue


SKILL_FILENAME = "SKILL.md"
SKILLS_STATE_FILENAME = ".xagent-skills.json"
BUILTIN_SKILLS_DIRNAME = "catalog"
...
class FilesystemSkillsStore:
    ...
    def _seed_builtin_skills(self) -> None:
        try:
            builtin_root = resources.files("xagent.tools.builtins").joinpath(BUILTIN_SKILLS_DIRNAME)
