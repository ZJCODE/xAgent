...
WORKSPACE_ASSET_ROOT = "assets"
WORKSPACE_INBOUND_LOCAL_IMAGE_DIR = f"{WORKSPACE_ASSET_ROOT}/inbound/local/images"
WORKSPACE_IMAGE_OUTPUT_DIR = WORKSPACE_INBOUND_LOCAL_IMAGE_DIR
