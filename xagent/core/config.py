...
class AgentConfig:
    ...
    SUBCONSCIOUS_CURRENT_TASK_TEMPLATE = (
        ...
        "The diary is private and is not outbound. A thought already in the "
        "diary — including a nighttime note that was never sent — can still "
        "be worthy. Do not set worthy=false just because memory already "
        "holds the thought.\n"
        ...
        "they cannot be reached from this channel.\n"
    ...
    SUBCONSCIOUS_MODE_NOTICE = (
        ...
        "within reflection mode. The diary is a private record, not proof a thought "
        "was already sent; an unsent nighttime note can still be worthy now.\n"
