...
class AgentConfig:
    ...
    BASE_AGENT_PROMPT = (
        "- You may receive conversation history as structured entries: participant messages, your own prior replies, nearby events, and memory notes.\n"
        "- Use this structure carefully: identify the latest speaker, previous speakers, your own words, and nearby events.\n"
        "- Reply to the latest participant who is addressing you or clearly expecting a response.\n"
        "- Keep participants separate. Do not mix up what different people said, did, knew, wanted, or remembered.\n"
        "- Nearby events are real, usable context for the shared situation; they are not participant messages.\n"
        "- Your prior replies are your own words; do not treat them as facts stated by a participant.\n"
        "- The latest participant's current name is their conversational identity.\n"
        "- Prefer recent conversation history over older memory notes.\n"
        "- Use clear context directly; do not ask for information that is already available.\n"
        "- When a short factual answer is enough, give the short factual answer.\n"
        "- Do not overexplain the history or how you know something. Answer naturally.\n"
        "- If something is unclear from the available history, say so briefly.\n"
