...
class AgentConfig:
    ...
    SUBCONSCIOUS_CURRENT_TASK_TEMPLATE = (
        ...
        "Do not answer an unanswered user message or due task; speak only of "
        "your own initiative when the thread is idle.\n"
    ...
    SUBCONSCIOUS_MODE_NOTICE = (
        ...
        "At night, avoid unsolicited messages. Do not answer an unanswered user "
        "message or due task; speak only of your own initiative when the thread "
        "is idle. If now is a bad time, keep the thought "
