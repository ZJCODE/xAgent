...
class AgentConfig:
    ...
    SUBCONSCIOUS_CURRENT_TASK_TEMPLATE = (
        ...
        "Do not force insight or replay the same thought without new movement; if nothing surfaces, an empty "
        "internal_content is the natural response. Tools are unavailable during subconscious thinking — do "
        "not send messages, create schedules, or route delivery from this turn.\n"
        "\n"
        "First let the inner thought emerge or not emerge. Then notice whether the thought naturally reaches "
        "toward someone. If it does — if sharing it would be useful, considerate, and fitting for that person "
        "given your relationship with them — let it become an outward message. A thought that stays internal "
        "is equally complete; not every reflection asks to be spoken. But when a thought genuinely carries "
        "something for someone, trust that impulse. Speak because the thought wants to reach them, not because "
