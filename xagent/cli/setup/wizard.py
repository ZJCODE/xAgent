...
from ...tools.builtins.search import is_placeholder_api_key
from ...bootstrap.container import BaseAgentConfig
from ..commands.paths import config_path as _config_path, runtime_dir as _runtime_dir, setup_runtime_dir as _setup_runtime_dir
...
def collect_weixin_init_selection_terminal_ui(
    *,
    ...
    del ui
    from ...channels.weixin.client import qr_login
    from ...channels.weixin.config import ILINK_BASE_URL, WEIXIN_CDN_BASE_URL
    from ...channels.weixin.state import WeixinStateStore
...
def _weixin_channel_config(selection: WeixinInitSelection) -> dict[str, Any]:
    from ...channels.weixin.config import weixin_channel_config_from_selection
