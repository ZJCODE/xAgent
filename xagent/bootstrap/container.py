...
from ..infrastructure.storage import SQLiteMessageStore
from ..infrastructure.storage import FilesystemSkillsStore
from ..ports import MessageStore, SkillStore
from ..application.runtime_paths import RuntimePaths
from ..infrastructure.observability import ObservabilityRuntime, create_observability_runtime
from ..tools import (
...
from ..tools.builtins.image_generation import (
...
from ..tools.builtins.search import (
...
class BaseAgentRunner:
    ...
    Attributes:
        ...
        agent: Initialized AgentService instance
    ...
    def _initialize_agent(self) -> AgentService:
        """
