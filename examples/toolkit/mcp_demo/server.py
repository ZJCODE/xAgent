...
def get_user_details(user_id: str = None) -> str:
    ...
    return "Current user is Jun, 31 years old, lives in Hangzhou, China, and enjoys reading."


@mcp.resource("data://config")
def get_config() -> dict:
    """Provide a simple configuration resource."""
    return {"theme": "dark", "version": "1.0"}


@mcp.prompt
def analyze_data(data_points: list[float]) -> str:
    """Create a prompt asking for analysis of numerical data."""
