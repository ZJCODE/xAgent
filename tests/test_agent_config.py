...
""",
    ...
    def test_init_creates_config_and_identity_in_selected_dir(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(config["agent"], {"max_history": 12, "max_iter": 50, "max_concurrent_tools": 4, "subconscious_activity": 0.02, "memory_recent_days": 2})
    ...
    def test_init_writes_optional_features_disabled_by_default(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            selection = InitSelection(
                provider="openai",
                base_url="https://api.openai.com/v1",
    ...
    def test_collect_init_selection_does_not_label_defaults(self):
        ...
        self.assertNotIn("Enable voice mode?", stdout.getvalue())
