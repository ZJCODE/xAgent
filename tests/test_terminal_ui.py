...
from xagent.cli.terminal_ui import MenuOption, ReturnToLauncherHome, TerminalUI
...
class TerminalUITests(unittest.TestCase):
    ...
    def test_select_records_the_resolved_choice(self):
        ...
        with patch("xagent.cli.terminal_ui.readchar.readkey", side_effect=lambda: next(keys)):
            choice = ui.select(
                label="Provider",
                options=[
